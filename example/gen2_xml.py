...
root_group2 = etree.SubElement(root, 'Group2')
group2_sub_var_str = etree.SubElement(root_group2, 'sub2_var_str')
group2_sub_var_str.text = 'text in group2'
group2_sub_var_int = etree.SubElement(root_group2, 'sub2_var_int')
group2_sub_var_int.text = '369'
group2_sub_var_float = etree.SubElement(root_group2, 'sub2_var_float')
group2_sub_var_float.text = '0.12'
...
tree.write('gen2.xml', pretty_print=True, xml_declaration=True, encoding='utf-8')
